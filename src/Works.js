...
<Block
    ...
    description="
        ...
        **KD-tree**を使用して高速に動作するアルゴリズムを使用している。
        " />
<Block
    title="VScode拡張機能"
...
<Block
    ...
    description="
        ...
        せっかくCUIのアプリを作るので**Vim**を使用して開発した。
        " />
<Block
    title="モバイルオーダー"
    team={true}
...
<Block
    ...
    description="
        ...
        「囲いパズル」のランダムな問題を生成する為のアルゴリズムを作成した。
        " />
<Block
    title="入退室管理アプリ"
    team={true}
...
<Block
    ...
    stack={["docker"]}
    description="
        **KC3**(関西情報系大学カンファレンス)にて**「1からはじめるDocker入門」**で登壇した。<br>
        docker compose を用いた開発用コンテナを作成する為のプロセスを紹介した。
        " />
<Block
    title="砂時計"
    stack={["arduino"]}
